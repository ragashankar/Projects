# Survey Data Analysis - Kaggle(https://www.kaggle.com/miroslavsabo/young-people-survey)
...
6.26 KB
Description
Mapping between original (long) variable names and their shortened versions.
Preview
